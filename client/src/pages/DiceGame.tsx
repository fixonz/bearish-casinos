...
const DiceGame: React.FC = () => {
  ...
  const gameData = getGameById('dice');
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="flex items-center mb-6 text-sm">
          ...
          <span className="mx-2 text-gray-600">/</span>
          <span className="text-[#FFD700]">Dice Roll</span>
        </div>
        
        {/* Game Title */}
        <div className="mb-8">
          <h1 className="font-poppins font-bold text-3xl md:text-4xl mb-2">Dice Roll</h1>
          <p className="text-gray-400 max-w-2xl">Roll the dice and win up to 6x your bet. Choose a number and see if the dice lands on your selection!</p>
        </div>
            ...
            <div className="bg-[#222222] rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <div className="font-semibold">16.7%</div>
                </div>
                <div>
                  <div className="text-gray-400 text-sm mb-1">Max Win</div>
                  <div className="font-semibold">6,000 ATOM</div>
                </div>
                <div>
                  <div className="text-gray-400 text-sm mb-1">Total Plays</div>
                  <div className="font-semibold">32,145</div>
                </div>
              </div>
